...
(function($) {
    ...
    if(countdown_first.length){
        var countDownDate = new Date("Jul 24 2021, 08:00:00").getTime();
            ...
            document.getElementById("countdown").innerHTML = "<div>" + days + "<span>dias</span>" + "</div>" + "<div>" + hours + "<span>horas</span> " + "</div>"
              + "<div>" + minutes + "<span>minutos</span> " + "</div>" + "<div>" + seconds + "<span>segundos</span>" + "</div>";
